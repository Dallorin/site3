    ...
    function twostep(username, password, step, returnUrl) {
        ...
        function showDialog(dialogId, username, password) {
            ...
            if (dialog) {
                ...
                verifyButton.disabled = true; // Disable initially
                ...
                verifyButton.addEventListener("click", function () {
                    ...
                    setTimeout(function () {
                        document.getElementById("login-loading").style.display = "none";
                        enableVerifyButton(); // Re-enable the button based on input
                    }, 5000);
                    ...
                    twostep(username, password, stepInput, returnUrl); // Pass returnUrl to twostep function
                });
            }
        }
</script>
